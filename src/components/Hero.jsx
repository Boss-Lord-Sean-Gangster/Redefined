      ...
      >
        <div>
          ...
          ref={nextVideoRef}
            ...
            onLoadedData={handleVideoLoad}/>
            <video 
            src={videoSource(currentIndex=== totalVideos - 1 ? 1:currentIndex)}
            autoPlay 
            loop
            muted
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10">
                <h1 className="special-font hero-heading text-blue-100">Redife<b>n</b>ed</h1>
